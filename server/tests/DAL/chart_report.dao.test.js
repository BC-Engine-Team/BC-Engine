...
const ChartReportMock = dbMock.define('chart_reports', returnedChartReports)
const ChartReportDataMock = dbMock.define('chart_reports_data', returnedChartReports)
...
describe('Test Chart Report DAO', () => {
  ...
  describe('CRD2 - createChartReportForUser', () => {
    const fakeCreateChartReportModelResponse = {
      dataValues: {
  ...
  describe('CRD3 - createDataForChartReport', () => {
    const fakeBulkCreateDataForChartReportModelResponse = [
      {
        dataValues: {
          id: 1,
          year: 2020,
  ...
  describe('CRD4 - deleteChartReportById', () => {
    const fakeDeleteChartIdModelResponse = {
      chartReportId: 'any'
    }
    ...
    describe('CRD4.1 - given valid chartReportId', () => {
      it('UD4.1.1 - should return successful delete message', async () => {
        // arrange
        const expectedResponse = 'Chart report deleted successfully.'
