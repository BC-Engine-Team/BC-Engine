...
describe("Test Invoice Affect DAO", () => {
    ...
    describe("IAD1 - getInvoicesByDate", () => {
        it("IAD1.1 - should return list of invoices", async () => {
            ...
            // act
            const response = await InvoiceAffectDao.getInvoicesByDate(fakeQuery, dbStub);
        ...
        it("IAD1.2 - should return false when db cant fetch data", async () => {
            ...
            // act and assert
            await expect(InvoiceAffectDao.getInvoicesByDate(fakeQuery, dbStub)).resolves
                .toEqual(false);
        });
        ...
        it("IAD1.3 - should catch error when db throws error", async () => {
            ...
            // act and assert
            await expect(InvoiceAffectDao.getInvoicesByDate(fakeQuery, dbStub)).rejects
