module.exports = (performanceReportInfo, performanceReportData, chartReportInfo, chartReportData) => {
    ...
    <html lang="en">
        ...
        <body>
            ...
            <h1>Chart Report - ${chartReportInfo.name}</h1>
            <div id="ReportInfo" class="clearfix">
                <h2 class="title">Report Information</h2>
                <div><span>Date Created</span> ${getFullDateFormatted(chartReportInfo.createdAt)}</div>
                <div><span>Date Last Updated</span> ${getFullDateFormatted(chartReportInfo.updatedAt)}</div>
