...
const Manage = () => {
    ...
    const findGradingCriteriaErrors = () => {
        ...
        if (parseInt(maximumGradeAPlus) < parseInt(minimumGradeAPlus) 
            ...
            newErrors.maximumGradeAPlus = "The maximum of grade A+ is smaller than one or multiple client grading below him"

        // minimum grade A+ errors
        if (parseInt(minimumGradeAPlus) > parseInt(maximumGradeAPlus) )
            newErrors.minimumGradeAPlus = "The minimum of grade A+ is bigger than maximum grade A+"
        ...
        if (parseInt(minimumGradeAPlus) < parseInt(maximumGradeA) 
            ...
            newErrors.minimumGradeAPlus = "The minimum of grade A+ is smaller than one or multiple client gradings"

        // maximum grade A errors
        if (parseInt(maximumGradeA) > parseInt(minimumGradeAPlus) 
            && parseInt(maximumGradeA) > parseInt(maximumGradeAPlus))
            newErrors.maximumGradeA = "The maximum of grade A is bigger than the gradings above"
        ...
        if (parseInt(maximumGradeA) < parseInt(minimumGradeA) 
            ...
            newErrors.maximumGradeA = "The maximum of grade A is smaller than one or multiple client gradings below"
        ...
        if (parseInt(minimumGradeA) > parseInt(maximumGradeA) 
            ...
            newErrors.minimumGradeA = "The minimum of grade A is bigger than the gradings above"
        ...
        if (parseInt(minimumGradeA) < parseInt(maximumGradeB) 
            ...
            newErrors.minimumGradeA = "The minimum of grade A is smaller than one or multiple client gradings below"
        ...
        if (parseInt(maximumGradeB) > parseInt(minimumGradeA) 
            ...
            newErrors.maximumGradeB = "The maximum of grade B is bigger than the gradings above"
        ...
        if (parseInt(maximumGradeB) < parseInt(minimumGradeB) 
            ...
            newErrors.maximumGradeB = "The maximum of grade B is smaller than one or multiple client gradings below"
        ...
        if (parseInt(minimumGradeB) > parseInt(maximumGradeB) 
            ...
            newErrors.minimumGradeB = "The minimum of grade B is bigger than the gradings above"
        ...
        if (parseInt(minimumGradeB) < parseInt(maximumGradeC) 
            ...
            newErrors.minimumGradeB = "The minimum of grade B is smaller than one or multiple client gradings below"
        ...
        if (parseInt(maximumGradeC) > parseInt(minimumGradeB)
            ...
            newErrors.maximumGradeC = "The maximum of grade C is bigger than the gradings above"
        ...
        if (parseInt(maximumGradeC) < parseInt(minimumGradeC) 
            ...
            newErrors.maximumGradeC = "The maximum of grade C is smaller than one or multiple client gradings below"
        ...
        if (parseInt(minimumGradeC) > parseInt(maximumGradeC)
            ...
            newErrors.minimumGradeC = "The minimum of grade C is bigger than the gradings above"

        if (parseInt(minimumGradeC) < parseInt(maximumGradeEPlus) 
            && parseInt(minimumGradeC) < parseInt(minimumGradeEPlus))
            newErrors.minimumGradeC = "The minimum of grade C is smaller than one or multiple client gradings below"
        ...
        if (parseInt(maximumGradeEPlus) > parseInt(minimumGradeC)
            ...
            newErrors.maximumGradeEPlus = "The maximum of grade E+ is bigger than the gradings above"

        if (parseInt(maximumGradeEPlus) < parseInt(minimumGradeEPlus))
            newErrors.maximumGradeEPlus = "The maximum of grade E+ is smaller than one or multiple client gradings below"
        ...
        if (parseInt(minimumGradeEPlus) > parseInt(maximumGradeEPlus)
            ...
            newErrors.minimumGradeEPlus = "The minimum of grade E+ is bigger than the gradings above"
        ...
        if (maximumGradeAPlus === 0
            ...
            || maximumGradeEPlus === 0
            || minimumGradeEPlus === 0)
            newErrors.minimumGradeEPlus = "Fill up all the inputs"
            ...
            <div className='justify-content-center mainContainer'>
                <div className='container-clientGradingBrackets'>
                    <div className='card shadow my-3 mx-3 px-3 py2'>
                        ...
                        <Form.Group className="my-2" controlId="floatingModifyClientGrading">
